...
export default class Editor extends Component {
    ...
    async save() {
        ...
        await axios
            ...
            .then(() => this.showNotifications('Success save', 'success'))
            .catch(() => this.showNotifications('Error save', 'danger'))
    ...
    restoreBackup(e, backup) {
        ...
        UIkit.modal.confirm("Are you seriously want to restore page?", {labels: {ok: 'Restore', cancel: 'Cancel'}})
            .then(() => {
                this.isLoading();
                return axios
    ...
    render() {
        ...
        return (
            <>
                ...
                <input id="img-upload" type="file" accept="images/*" style={{display: 'none'}} />
